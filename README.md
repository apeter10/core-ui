...
[![Greenkeeper badge](https://badges.greenkeeper.io/Sanji-IO/core-ui.svg)](https://greenkeeper.io/)

This core is under active development and hasn't yet reached its final form.
...
This is a simple library core for Angular libraries, implementing the
...
[travis-badge]: https://travis-ci.org/filipesilva/angular-core-lib.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-core-lib
...
1. Create a project folder (you can call it `core-lib` and rename it later).
...
```
git clone https://github.com/angular/core-lib.git core-lib
cd angular-core-lib
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-core-lib/archive/master.zip)
...
The **QuickStart Library seed** contains a similar structure to the [Quickstart seed](https://github.com/angular/core).
...
Use your editor to search the project for all instances of `angular-core-lib` and change it
